...
echo "$White\n\n";
echo "------ PHP ratemax.php -----\n";
echo "----------------------------\n";
echo "- Raters:  username        -\n";
...
$usernamearray=[];
echo "$White";
echo "Input the RATERS username\n";
echo "(blank) to skip\n";
do {
...
DATA;
  ...
  echo $json->message; 
          ...
          echo "$Yellow";
          echo "\n\n[ratemax.php]->message->pls. wait...\n";
          sleep(2);

      } //end of foreach username  
  } //end of status==1  
  echo "$White";
  echo "\n\n[max2u.php]->message-> end of rating.\n";
