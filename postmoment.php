...
/*
# Bold
define ($BBlack,"\033[1;30m",true) ;      # Black
define ($BRed,"\033[1;31m",true) ;        # Red
define ($BGreen,"\033[1;32m",true) ;      # Green
define ($BYellow,"\033[1;33m",true) ;     # Yellow
define ($BBlue,"\033[1;34m",true) ;       # Blue
define ($BPurple,"\033[1;35m",true) ;     # Purple
define ($BCyan,"\033[1;36m",true) ;       # Cyan
define ($BWhite,"\033[1;37m",true) ;      # White
*/
...
echo "$White\n\n";
echo "-------------------------------\n";
echo "----- PHP postmoment.php  -----\n";
echo "-     add posts / moments     -\n";
echo "-                             -\n";
echo "--------(c)maximum001 ---------\n";
echo "-------------------------------\n\n";
...
$usernamearray = []; 
echo "$Cyan";
echo "Input the username to add posts/moments\n";
echo "(blank) to skip\n\n";
echo "$White";
do {
   $username = readline("\nUsername: ");
...
function addPosts($user, $bearer, $device_id, $contents, $xhash) {
   ...
   $uploadPay = <<<DATA
       {"category":"post","clientId":"$user_id","files":[{"fileName":"https://github.com/maximum001/images/blob/main/p1.jpeg", "mediaType":"image"}]}
   DATA; 
...
function payroyalty($carrier) {
    ...
    $urld = "https://profiles.mylykaapps.com/api/v3/profiles/GetProfilePosts?os=android&pageIndex=1&pageSize=50&id=$userID&category=ALL";
...
for ($postloop=1; $postloop<11; $postloop++) {   
  ...
  {
    "device": {
    "deviceId": "29b3e709883d7321",
    "deviceImei": "29b3e709883d7321",
    "deviceModel": "Tecno Spark 7 Pro",
    "deviceName": "android",
